...
Entonces, con estos datos se utilizó la Ecuación \ref{Ec1} pudiéndose obtener las frecuencias de cada uno. La Figura $\ref{Graf2}$ muestra la gráfica de $\nu \text{ vs. } V_{A-K}$, en donde se realizó una regresión lineal omitiendo la medición más dispersa.
