...
Al graficar el campo eléctrico reducido contra velocidad de deriva  se obtuvieron las siguientes graficas que se muestran en la figura \ref{Graf:Graficas}
