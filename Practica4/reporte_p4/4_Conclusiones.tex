...
En la primer parte del experimento al mezclar 99\% de Argón y 1\% de Nitrógeno, se logro observar el comportamiento de la velocidad de deriva $v_d$ para un intervalo de 10.1 a 200.2Torr, visualizando que en esta se dividía en tres secciones la primera entre  0 y 5 Td donde $v_d$ aumenta rápidamente, seguida de una sección de 5 a 11 Td donde disminuye, y finalmente la ultima sección donde vuelve a subir pero de una manera mas controlada. De estas observaciones se determino que la segunda sección de 5 a 11 Td el fenómeno que explicaba esta disminución en la velocidad era la conductividad diferencial negativa.
 De igual manera se logro apreciar que $v_d$ depende unicamente de $E/N$ y es totalmente independiente de la presión, aun que se debe de tener en cuenta esta para la preservación del equipo. 
